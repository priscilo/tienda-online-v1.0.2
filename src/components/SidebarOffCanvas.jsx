...
const SidebarOffCanvas = () => {
  ...
  const generateWhatsAppMessage = () => {
    let message = "Hola Priscilo, saludos. Quiero este pedido:\n\n";
    cart.forEach((product) => {
      message += `Producto: ${product.title}\nCantidad: ${product.quantity}\nPrecio: S/${product.price}\n\n`;
    });
    message += `Subtotal: S/${calculateSubtotal().toFixed(2)}`;
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="col-3 text-end">
                <span className="fw-bold">
                  ...
                  <strong className="fs-5 precio">S/{productCart.price}</strong>
                </span>
                <button
      ...
      <div className="offcanvas-footer mt-4 px-2">
        <div className="d-flex justify-content-between align-items-center">
          <h5 className="mb-5">
            ...
            <span className="fw-bold float-end px-2 fs-2">
              <span style={{ color: "#ff9c08" }}>S/</span>
        ...
        {cart.length > 0 && (
          <a
            href={`https://api.whatsapp.com/send?phone=+51922931828&text=${generateWhatsAppMessage()}`}
